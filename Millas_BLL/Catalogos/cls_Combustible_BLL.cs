...
{
    public class cls_Combustible_BLL
    {
        #region Listar
        public void List_Combustible(ref cls_Combustible_DAL Obj_Combustible_DAL)
        {
            ...
            {
                Obj_Combustible_DAL.dData = Obj_BD_DAL.Ds;
                Obj_Combustible_DAL.sMgsError = string.Empty;
            }
            else
            {
                Obj_Combustible_DAL.dData = null;
                Obj_Combustible_DAL.sMgsError = Obj_BD_DAL.sMsError;
            }
        }
        #endregion
        #region Filtrar
        public void Fill_Combustible(ref cls_Combustible_DAL Obj_Combustible_DAL)
        {
            cls_BD_BLL Obj_BD_BLL = new cls_BD_BLL();
            cls_BD_DAL Obj_BD_DAL = new cls_BD_DAL();
            ...
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@filtro", "1", Obj_Combustible_DAL.sDescripcion);

            Obj_BD_DAL.sParametro = ConfigurationManager.AppSettings["filtrarcombustibles"].ToString();
            Obj_BD_DAL.sNombreTabla = ConfigurationManager.AppSettings["tablacombustibles"].ToString();
        ...
        #endregion
        #region Actualizar
        public void Update_Combustible(ref cls_Combustible_DAL Obj_Combustible_DAL)
        {
            cls_BD_BLL Obj_BD_BLL = new cls_BD_BLL();
            cls_BD_DAL Obj_BD_DAL = new cls_BD_DAL();
            ...
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@Descripcion", "1", Obj_Combustible_DAL.sDescripcion);
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@Estado", "7", Obj_Combustible_DAL.cEstado);
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@Id_Actualiza_Empleados", "2", Obj_Combustible_DAL.iCod_EmpleCreador);
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@FechaActualizado", "6", Obj_Combustible_DAL.FechaCreado);

            Obj_BD_DAL.sParametro = ConfigurationManager.AppSettings["modificarcombustibles"].ToString();
