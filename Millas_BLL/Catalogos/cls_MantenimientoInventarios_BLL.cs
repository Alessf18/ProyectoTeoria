...
{
    public class cls_MantenimientoInventarios_BLL
    {
        #region Listar
        public void List_MantenimientoInventarios(ref cls_MantenimientoInventarios_DAL Obj_MantenimientoInventarios_DAL)
        {
            cls_BD_BLL Obj_BD_BLL = new cls_BD_BLL();
            cls_BD_DAL Obj_BD_DAL = new cls_BD_DAL();

            Obj_BD_DAL.sParametro = ConfigurationManager.AppSettings["listarmantenimientoinventario"].ToString();
            Obj_BD_DAL.sNombreTabla = ConfigurationManager.AppSettings["tablamantenimientoinventario"].ToString();

            Obj_BD_BLL.Excute_DataAdapter(ref Obj_BD_DAL);

            if (Obj_BD_DAL.sMsError == string.Empty)
            {
                Obj_MantenimientoInventarios_DAL.dData = Obj_BD_DAL.Ds;
                Obj_MantenimientoInventarios_DAL.sMgsError = string.Empty;
            }
            else
            {
                Obj_MantenimientoInventarios_DAL.dData = null;
                Obj_MantenimientoInventarios_DAL.sMgsError = Obj_BD_DAL.sMsError;
            }
        }
        #endregion
        #region Filtrar
        public void Fill_MantenimientoInventarios(ref cls_MantenimientoInventarios_DAL Obj_MantenimientoInventarios_DAL)
        {
            cls_BD_BLL Obj_BD_BLL = new cls_BD_BLL();
            cls_BD_DAL Obj_BD_DAL = new cls_BD_DAL();
            ...
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@filtro", "1", Obj_MantenimientoInventarios_DAL.sDescripcion);

            Obj_BD_DAL.sParametro = ConfigurationManager.AppSettings["filtrarmantenimientoinventario"].ToString();
            Obj_BD_DAL.sNombreTabla = ConfigurationManager.AppSettings["tablamantenimientoinventario"].ToString();
        ...
        #endregion
        #region Insertar
        public void Insert_MantenimientoInventarios(ref cls_MantenimientoInventarios_DAL Obj_MantenimientoInventarios_DAL)
        {
            cls_BD_BLL Obj_BD_BLL = new cls_BD_BLL();
            cls_BD_DAL Obj_BD_DAL = new cls_BD_DAL();
            ...
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@Id_Crea_Empleados", "2", Obj_MantenimientoInventarios_DAL.iCod_Emple);
            Obj_BD_DAL.Dt_Parametros.Rows.Add("@FechaCreado", "6", Obj_MantenimientoInventarios_DAL.Fecha);

            Obj_BD_DAL.sParametro = ConfigurationManager.AppSettings["insertarmantenimientoinventario"].ToString();
